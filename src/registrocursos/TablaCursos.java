...
public class TablaCursos extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnConsultar1.setText("Modificar");

        btnConsultar2.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        btnConsultar2.setText("Remover");
        btnConsultar2.setActionCommand("Remover");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TablaCursos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TablaCursos().setVisible(true);
            }
        });
    }
